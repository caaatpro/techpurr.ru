...
if ( is_singular() ) { ?>
	...
	<?php if( wpex_get_data( 'blog_single_thumbnail', '1' ) == '1' && has_post_thumbnail() ) { ?>
        <div id="post-thumbnail">
			<img src="<?php echo p_get_attachment_url( get_post_thumbnail_id()); ?>" alt="<?php echo the_title(); ?>" />
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('post-entry clr'); ?>>
        <?php if( has_post_thumbnail() ) {  ?>
            <div class="post-entry-thumbnail">
                <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img src="<?php echo wp_get_attachment_url( get_post_thumbnail_id() ); ?>" alt="<?php echo the_title(); ?>" /></a>
